...
export default function SignUp() {
  usePageMeta({ title: 'Sign Up', description: 'Create a free WeCam account to unlock gender filters for random video chat. Talk to strangers your way.', path: '/signup' });
